...
double* create_centroid_data(double *vector_data, int k, int vector_len) {
    double *tmp;
    int i;
...
int main(int argc, char **argv)
{
    ...
    int vec_size = 1, vec_num = 0, arr_size, iter = 200;
    double n;
    char c;
    int i =0, k;
    double *coor_arr;
    ...
    centroid_data = create_centroid_data(vector_data, k, vector_len);
